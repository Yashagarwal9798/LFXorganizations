...
export default function OrganizationsError({ error, reset }) {
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <p className="text-cyber-fg-muted text-base leading-relaxed mb-8">
          We couldn&apos;t fetch the organizations data right now. This might
          be a network issue or a temporary server hiccup. Please try again.
        </p>
